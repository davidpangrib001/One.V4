          ...
          for (let user of participants) {
            ...
            try {
              ...
              let lea = await new knights.Goodbye()
                ...
                .setMemberCount(groupMetadata.participants.length)
                .setAvatar(pp)
                .setBackground("https://telegra.ph/file/b7ea279081498dbc8efb2.jpg")
                .toAttachment()
...
global.dfail = (type, m, conn) => {
  ...
  let msg = '*Hanya Owner Yang Bisa Mengakses Fitur Ini*',
    mods: '*Hanya Moderator Yang Bisa Mengakses Fitur Ini*',
    premium: '*Fitur Khusus User Premium*',
    group: '*Gunakan Fitur Ini Di Grup*',
    private: '*Gunakan Fitur Ini Di Chat Pribadi*',
    admin: '*Hanya Admin Grup Yang Bisa Mengakses Fitur Ini*',
    nsfw: 'Perintah ini hanya bisa diaktifkan oleh owner',
  }[type]
  if (msg) return conn.sendButton(m.chat, msg, watermark, 'Oke', 'Nanii', m)
  let botAdmin = {
