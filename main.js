...
conn.browserDescription =['Linux', 'Replit', '3.0']
...
global.reloadHandler = function () {
  ...
  conn.bye = 'Nice, Beban Berkurang Satu!\n@user Leave Form *@subject*'
  conn.spromote = 'Pemberitahuan:\n@user Sekarang *Adalah Admin* Yah.. Gak Sekalian Kek Aku Jadi Adminnya.. 🤭'
  conn.sdemote = 'Pemberitahuan:\n@user Sekarang *Bukan Admin* Selamat 😍'
...
async function _quickTest() {
  ...
  if (!s.ffmpeg) conn.logger.warn('Tolong Install Alat FFmpeg Untuk Mengkonversi Sebuah File Dan Lain Lain (apt install ffmpeg)')
  ...
  if (!s.convert && !s.magick && !s.gm) conn.logger.warn('Stiker mungkin tidak berfungsi tanpa imagemagick jika libwebp di ffmpeg tidak diinstal (apt install imagemagick)')
}
